...
function(fixup_bundle_item resolved_embedded_item exepath dirs)
  ...
  find_program(CMAKE_CODESIGN_TOOL NAMES codesign HINTS ${_CMAKE_TOOLCHAIN_LOCATION})
  ...
  if(changes)
    ...
    if(NOT "${resolved_embedded_item}" MATCHES "\\.(bat|c?sh|bash|ksh|cmd)$" AND
      ...
      # Resign after install_name_tool execution
      set(cmd ${CMAKE_CODESIGN_TOOL} -s - -f -o linker-signed "${resolved_embedded_item}")
      execute_process(COMMAND ${cmd} RESULT_VARIABLE codesign_tool_result)
      if(NOT codesign_tool_result EQUAL 0)
        string(REPLACE ";" "' '" msg "'${cmd}'")
        message(FATAL_ERROR "Command failed:\n ${msg}")
      endif()
    endif()
